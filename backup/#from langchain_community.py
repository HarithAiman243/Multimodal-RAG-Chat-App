...
class OpenAIChain:
    def __init__(self, chat_memory) -> None:
        prompt = ChatPromptTemplate.from_messages(
            [
                ('system', 'You are an honest and unbiased AI assistant'),
        ...
        llm = ChatOpenAI(**config['chat_model'])
...
class OpenAIRAGChain:
    def __init__(self, chat_memory, uploaded_file=None):
        ...
        self.llm = ChatOpenAI(**config['chat_model'])
        ...
        # initialize qa chain
        qa_system_prompt = """You are an expert AI Digital Marketing assistant for answering questions about Campaigns, Ads. 
